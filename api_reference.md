...
See [Programming agents using the API](/docs/services/voice-agent?topic=voice-agent-api) for code examples and examples of how to set states and initiate action sequences.
