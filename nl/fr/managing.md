...
Vous souhaiterez peut-être supprimer un agent vocal afin de libérer le numéro de téléphone. Un seul agent vocal peut être associé à un numéro de téléphone. Afin d'utiliser un numéro de téléphone pour un autre agent vocal, vous devez d'abord supprimer l'agent vocal qui utilise le numéro de téléphone.
