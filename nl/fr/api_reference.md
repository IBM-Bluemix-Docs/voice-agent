...
Voir [Programmation des agents vocaux à l'aide de l'API](api.html) pour obtenir des exemples de code et des exemples de définition des états et d'initiation de séquences d'action.
