...
Anote el número de teléfono y el URI de terminación que desea transferir. Posteriormente, puede especificarlos como destino de transferencia en el diálogo de {{site.data.keyword.conversationshort}}.
