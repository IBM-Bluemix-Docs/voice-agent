...
| Nombre de variable de estado | Valor esperado | Descripción |
| -------------- | ----- | ----------- |
| `vgwSessionID`   | Definido por el usuario <br/><br/> Predeterminado: `Call-ID` | Una cabecera de ID de sesión personalizada que se obtiene de la solicitud SIP INVITE. El valor representa el ID de sesión global que se utiliza en todos los registros de auditoría del agente de voz relacionados con la sesión. |
