...
Consulte [Programación de agentes de voz mediante la API](api.html) para ver ejemplos de código y ejemplos de cómo definir estados e iniciar secuencias de acciones.
